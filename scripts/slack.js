  ...
  return {
    ...
    attachments: [{
      ...
      fields: [
        ...
        field('Next step',         'Resolve the conflicts, merge the PR into `develop`, then go to the Actions run → *Review deployments* → Approve `release-gate` to continue'),
      ],
  ...
  return {
    ...
    attachments: [{
      ...
      fields: [
        ...
        field('Action',      'Merge the PR into `develop`, then go to the Actions run → *Review deployments* → Approve `release-gate` to continue the release cut'),
      ],
      footer: `Run #${process.env.RUN_NUMBER || '?'}`,
    }],
  };
